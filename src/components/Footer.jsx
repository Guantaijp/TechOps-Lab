            ...
            <div className="bg-[#000000]  w-full">
                <div className=" justify-center flex flex-row p-6">
                    ...
                    <div className=" justify-around items-center p-6 w-1/4  ">
                        ...
                        <hr className="border-[#A47E1B] border-l-2 w-20 items-center" />
                        <Link to="/">  <p className="text-white hover:text-[#A47E1B]">Home</p></Link>
                        <Link to="/tech">  <p className="text-white hover:text-[#A47E1B]">Tech Company</p></Link>
                        <Link to="/writing">  <p className="text-white hover:text-[#A47E1B]">Writing Agency</p></Link>
                        <Link to="/art">  <p className="text-white hover:text-[#A47E1B]">Art Gallery</p></Link>
                        <Link to="/about">  <p className="text-white hover:text-[#A47E1B]">About</p></Link>
                        <Link to="/contact">  <p className="text-white hover:text-[#A47E1B]">Contact</p></Link>
                    </div>
                </div>
                ...
                <div className='justify-center items-center flex flex-col '>
                    ...
                    <div className='flex flex-row text-center font-bold text-white my-2'>
                        <p className='text-center mx-auto'>
                            ...
                            <span className="text-md text-[#A47E1B]"> TechOps Lab </span>
                            . All rights reserved
                        </p>
                    </div>
                </div>
