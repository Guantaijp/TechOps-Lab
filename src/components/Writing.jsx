...
function Writing() {
 ...
 <div className="main-container mb-2 flex flex-row flex-wrap justify-between">
 
  <div className="grid flex-row grid-cols-1 md:grid-cols-2 w-full">
    <div className="bg-[#b39231] text-center mt-1">
      <img alt="example" src={Writing1} className="h-auto mt-2 mb-2 rounded-lg na w-2/3 mx-auto" />
    </div>

    <div className="bg-[#806517] text-center font-serif mt-1">
      <h1 className="text-3xl font-bold mt-4">Copyrighting</h1>
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 w-full">
    <div className="bg-[#806517] text-center font-serif">
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 w-full">
    <div className="bg-[#b39231] text-center1">
      <img alt="example" src={Writing4} className="h-auto mt-2 mb-2 rounded-lg na w-2/3 mx-auto" />
    </div>
    ...
    <div className="bg-[#806517] text-center font-serif ">
      ...
      <div className="services bg-[#806517] p-4 sm:p-8 md:p-12">
        ...
        <p className="text-white text-center mt-3 text-lg sm:text-xl md:text-2xl">
